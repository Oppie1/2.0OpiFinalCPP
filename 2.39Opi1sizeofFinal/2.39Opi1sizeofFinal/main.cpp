...
int main() {
	...
	//Declare uninitialized double array named adam with 10 elements.
	//CODE:

	cout << "One element of the adam array as a double is: " << endl;
	//Output showing size of one element of the adam array
	//CODE:
	...
	//Output showing size of the whole adam array
	//CODE:
	...
	//Output displaying how many elements are in adam array using sizeof().
	//CODE:
