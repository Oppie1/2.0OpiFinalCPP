...
//Declare a class named codeRocksClass.
//CODE:
...
//Create a string var that stores a name.
//CODE:

//Create an int var that will hold an age.
//CODE:

//Create a var that will store gpa (decimal).
//CODE:

//Declare constructor with string, int and double as parameter (a, b, c) which will set values to vars
//where that information will be stored. The constructor MUST be class's name.
//CODE:
...
//Declare vars (attributes) that will store info from the constructor (year, make, model).
//CODE:
...
int main() {
	...
	//Create an example just to show you can have main drawing from multiple classes. EXACT same
	//concepts as above for the car class.
	//CODE:
